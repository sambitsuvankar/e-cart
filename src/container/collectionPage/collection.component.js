...
const CollectionComponent = (props) => {
    ...
    return(
        <div key={props.id} onClick={() => navigate(`${location.pathname}/${props.id}`)} className="w-auto h-60 sm:h-96 col-span-2 sm:col-span-1 flex flex-col bg-white rounded-2xl m-2 cursor-pointer shadow-2xl overflow-hidden" >
